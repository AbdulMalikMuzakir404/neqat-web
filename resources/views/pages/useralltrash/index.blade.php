...
@section('title')
    <title>Neqat &mdash; User All Trash</title>
@endsection
...
@push('styles')
    ...
    @include('pages.useralltrash.styles.main-style')
@endpush
    ...
    <div class="main-content">
        ...
        <section class="section">
            <div class="section-header">
                <h1>User All Trash</h1>
            </div>

            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('home.index') }}">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">User All Trash</li>
                </ol>
            </nav>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="m-0">User All Trash Table</h4>
                            <div class="">
                                <button type="button" class="btn btn-danger" id="deleteBtn" style="display: none">Delete
                                    <i class="ion ion-close-circled" style="font-size: 12px"></i></button>
                            </div>
                        </div>
                        <div class="card-body">
...
@push('scripts')
    ...
    @include('pages.useralltrash.scripts.main-script')
@endpush
